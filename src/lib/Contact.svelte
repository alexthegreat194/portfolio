...
id="contact">
    ...
    <div class="grid grid-row-3 sm:grid-cols-3 w-full sm:w-fit m-0 sm:m-5 justify-center items-center gap-4 text-red-700">
        <a href="https://github.com/alexthegreat194" target="_blank" on:click={() => trackSocialClick('github')}>
            <div class="group flex justify-center items-center gap-4 shadow-xl border bg-gray-800 hover:bg-red-700 border-red-700 text-red-700 hover:text-red-50 hover:fill-gray-50 py-10 px-16 sm:rounded-l-2xl">
        ...
        <a href="https://www.linkedin.com/in/alexander-harlan/" target="_blank" on:click={() => trackSocialClick('linkedin')}>
        ...
        <a href="mailto:alexharlan194@gmail.com" target="_blank" on:click={() => trackSocialClick('email')}>
